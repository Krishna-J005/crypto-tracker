                        ...
                        <tr key={crypto.cryptoId}>
                            ...
                            <td>
                                <div className='middle'>
                                    <img loading="lazy" style={{ marginRight: '8px' }} src={crypto.logo} alt={`${crypto.cryptoName} Logo`} width="24px"></img>
                                    <span style={{ marginRight: '8px' }}>{crypto.cryptoName} </span>  ({crypto.cryptoId})
                                </div>
                            </td>
